...
#define MAX_MODULATION_97_PER_CENT
...
#define OVERVOLTAGE_THRESHOLD_V		64		//Volt on DC Bus of MB459 board
#define UNDERVOLTAGE_THRESHOLD_V	15		//Volt on DC Bus of MB459 board
...
#define PID_SPEED_KP_DEFAULT      (s16)150
#define PID_SPEED_KI_DEFAULT      (s16)75
#define PID_SPEED_KD_DEFAULT      (s16)5
...
#define PID_TORQUE_REFERENCE   (s16)638 //(N.b: that's the reference init
				//value in both torque and speed control)

#define PID_TORQUE_KP_DEFAULT  (s16)1257
#define PID_TORQUE_KI_DEFAULT  (s16)814
#define PID_TORQUE_KD_DEFAULT  (s16)50

/* default values for Flux control loop */
#define PID_FLUX_REFERENCE   (s16)0
#define PID_FLUX_KP_DEFAULT  (s16)1257
#define PID_FLUX_KI_DEFAULT  (s16)814
#define PID_FLUX_KD_DEFAULT  (s16)50

// Toruqe/Flux PID  parameter dividers
#define TF_KPDIV ((u16)(512))
#define TF_KIDIV ((u16)(8192))
