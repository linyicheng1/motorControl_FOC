...
u8 ReadHallState(void)
{
  ...
  ReadValue = GPIO_ReadInputData(GPIOA) & GPIO_MSK;
  
#elif defined(TIMER3_HANDLES_HALL)
  ReadValue = (GPIO_ReadInputData(GPIOC)>>6) & GPIO_MSK;
  
#elif defined(TIMER4_HANDLES_HALL)
  ReadValue = (GPIO_ReadInputData(GPIOB)>>6) & GPIO_MSK;
